...
if not login_result.get("authenticated", False):
...
st.sidebar.success(f"✅ Sesión iniciada: {username}")

st.title("🌾 Plataforma AgTech - DEMO")
st.success("🎉 Has ingresado correctamente.")

# Aquí va tu app principal ⬇️
st.title("🌾 Plataforma AgTech Inteligente")
st.write("Aquí irá el análisis completo...")
# 📁 Cargar umbrales personalizados por cultivo
# Open and load JSON file for crop thresholds
...
# (Duplicate st.set_page_config not needed here)
